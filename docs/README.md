...
| [RAID_SYSTEM.md](RAID_SYSTEM.md) | Raid system design — each raid a three-room boss expedition (warm-up → mini-boss → tougher final boss), shared timer + raid HP, **twelve distinct room mechanics (none reused)**, native in-mechanic boss threats incl. the red/green combat duel, boss phases/enrage, tier scaling, flawless bonus, and the XP-lamp reward. |
