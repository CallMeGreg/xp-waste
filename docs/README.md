...
| [ACHIEVEMENTS.md](ACHIEVEMENTS.md) | Design proposal for the **Adventurer's Log** — Feats, Reward Tokens, the Reward Vault (XP Lamps + capes), the Collection Log, and how IAP expedites/unlocks it. |
